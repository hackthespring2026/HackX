...
from sentinel.views import POSLogViewSet, AlertViewSet, WorkShiftViewSet, SafetyLogViewSet, DrawerEventViewSet
...
router.register(r'drawer-events', DrawerEventViewSet, basename='drawerevent')
