...
# Adjust this zone to your setup
DRAWER_ZONE = (200, 230, 500, 420) 
...
while True:
    ...
    for r in results:
        for box in r.boxes:
            ...
            if class_name == DRAWER_PLACEHOLDER:
                ...
                zone_box = DRAWER_ZONE

                overlap = overlap_ratio(drawer_box, zone_box)

                if overlap > 0.6:   # >60% inside zone = closed
                    drawer_state = "CLOSED"
                    color = (255, 0, 0)
                else:
                    drawer_state = "OPEN"
    ...
    cv2.imshow("Drawer Open/Close (Stable Zone Logic)", frame)
